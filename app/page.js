      ...
      <main className="flex min-h-screen flex-col items-center bg-gradient-to-r from-[#322D35] to-[#4C454F]">
        ...
        <div className="block sm:flex sm:flex-row py-10 px-4 lg:px-0 max-w-5xl">
          <div className="w-full sm:flex sm:w-2/4">
            ...
            <div className="px-4 sm:px-0">
              ...
              />
              <Image
                src="/FS2026_Homepage_LeftStack_061426.png"
                alt="banner left"
                width={500}
                height={400}
              />
        ...
        <div className="block sm:flex sm:flex-row max-w-5xl p-2 sm:p-0">
          <div className="w-full sm:flex-col sm:flex sm:w-2/4 m-0 sm:m-2 mt-0 sm:mt-2 p-4 bg-[#F0E5D1] text-center text-[#322D25]">
            ...
            <p>
              <span className="font-bold">Hear</span> amazing concerts & performances all summit long. Evening concerts from Deep Sea Diver (solo), Jake Xerxes Fussell, Cameron Knowler, Hand Habits, Michael Daves & Jacob Jolliff, and The Volcano Brothers. Of course, there’s always surprise guests at Fretboard Summit
            </p>
          </div>
